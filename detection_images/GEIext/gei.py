...
import cv2
import os
x=os.listdir("/home/MMI22sunki/yolact/detection_images")
y=len(x)

path = "/home/MMI22sunki/yolact/detection_images/*.png"
X=np.zeros((128, 88))
...
cv2.imwrite('/home/MMI22sunki/yolact/detection_images/GEIext.png',GEI)